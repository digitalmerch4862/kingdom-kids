  ...
  const handleAnswer = (option: string) => {
    ...
    setTimeout(async () => {
      ...
      if (currentQuestion + 1 < story.quiz.length) {
        ...
        // Game Over - Check if passed (e.g. need at least 1 correct? or just completion)
        // For now, completion is victory
      ...
      <div className="w-full max-w-2xl bg-white rounded-[2.5rem] shadow-xl shadow-pink-100/50 border border-pink-50 overflow-hidden min-h-[500px] relative">
        ...
        {gameState === 'LOADING' && (
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
            ...
            <p className="text-gray-400 font-black uppercase tracking-widest text-xs">Asking the AI for a story...</p>
          </div>
        )}
